...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (btnConfirmar) btnConfirmar.addEventListener('click', enviarPedido);
    if (btnCancelar) btnCancelar.addEventListener('click', cancelarPedido);

    // Evento de input para calcular a taxa de entrega
    const campoBairro = document.getElementById("bairro");
    if (campoBairro) {
        campoBairro.addEventListener("input", calcularTaxaEntrega);
    }
